<template>
  <div>
    <svg
      ...
      y="0px"
    >
      <path d="M0,66 604,66 L539,0" opacity="0.3" stroke="#3581fb" stroke-width="2" />
      <path d="M562,0 616,54" opacity="0.54" stroke="#3581fb" stroke-width="2" />
      <path d="M616,54 636,73 L656,73" stroke="#3581fb" stroke-width="3" />
      <path d="M656,73 945,73" opacity="0.54" stroke="#3581fb" stroke-width="2" />
      <path d="M945,73 965,73 L985,54" stroke="#3581fb" stroke-width="3" />
      <path d="M985,54 1039,0" opacity="0.54" stroke="#3581fb" stroke-width="2" />
      <path d="M1062,0 997,66 L1600,66" opacity="0.3" stroke="#3581fb" stroke-width="2" />
    </svg>
    <div id="project-name">
      <el-select @change="changeBelong" placeholder="请选择" v-model="belong">
        <el-option
          :key="item.value"
          :label="item.name"
          :value="item.id"
